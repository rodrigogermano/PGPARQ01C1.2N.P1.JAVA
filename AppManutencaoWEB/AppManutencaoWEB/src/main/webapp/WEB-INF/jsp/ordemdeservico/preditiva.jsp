...
<div class="container mt-3">
	...
	<form method="post" action="/solicitacao/preditiva">
		...
		<div class="row">
			...
			<div class="col-6">
				<div class="form-group">
			    	<label>Análise de vibração</label>
			    	<select class="form-control" name="analiseDeVibracao">
		...
		<div class="row">
			<div class="col-6">
				...
				<select class="form-control" name="ultrassom">
			      <option value="false" selected>Não</option>
			      <option value="true">Sim</option>				      
			    </select>  
			</div>
			<div class="col-6">
				...
				<select class="form-control" name="inspecaoVisual">
			      <option value="false" selected>Não</option>
			      <option value="true">Sim</option>				      
			    </select>  
			</div>
