		  ...
		  <div class="row no-gutters">
		    ...
		    <div class="col-md-12">
		      <div class="card-body">
		        ...
		        <p class="card-text">		        
		        	Cliente: ${solicitacao.getCliente().getNome()}	        	
		        </p>
		         <div class="card-body">
		         	<a href="/solicitacao/${solicitacao.getId()}/detalhe" class="card-link">Detalhe</a>
				    <a href="/solicitacao/${solicitacao.getId()}/excluir" class="card-link" style="color: #bf1515 !important;">Excluir</a>				    
				  </div>		        
		      </div>
		    </div>
		  </div>
